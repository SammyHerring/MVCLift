...
/// CLASS FROM EXTERNAL SOURCE
/// Code Source: http://www.camick.com/java/source/MessageConsole.java
/// Author: Rob Camick, 2008. From Blog: https://tips4java.wordpress.com/2008/11/08/message-console/

/*
 *  Create a simple console to display text messages.
 *
 *  Messages can be directed here from different sources. Each source can
 *  have its messages displayed in a different colour.
 *
...
public class MessageConsole
{
	 ...
	 *  using the default text colour and null PrintStream
	 */
	...
	/*
	 *  Redirect the output from the standard output to the console
	 *  using the specified colour and PrintStream. When a PrintStream
	...
	class ConsoleOutputStream extends ByteArrayOutputStream
	{
		...
		/*
		 *  Specify the option text colour and PrintStream
		 */
